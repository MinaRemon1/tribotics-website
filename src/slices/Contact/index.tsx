...
const Contact = ({ slice }: ContactProps): JSX.Element => {
  const [email, setEmail] = useState("mwpepgdg");
  ...
  const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    if (formRef.current) {
      formRef.current.action = `https://formspree.io/f/${email}`;
    }
  };
  ...
  return (
    ...
    >
      <div className="flex flex-col min-h-screen">
        ...
        <div className="flex-grow px-[10%] w-screen">
          ...
          <form ref={formRef} method="POST" className="flex flex-col justify-center items-center space-y-5 mx-5 pb-20">
            ...
            <Select onValueChange={handleSelectChange}>
              <SelectTrigger name="Enquiry Type" className="w-96 mr-5 ml-5">
                <SelectValue placeholder="Enquiry Type" />
              </SelectTrigger>
              <SelectContent>
                <SelectItem value="General Enquire">General Enquire</SelectItem>
                <SelectItem value="Servicing and Support">Servicing and Support</SelectItem>
              </SelectContent>
            </Select>
